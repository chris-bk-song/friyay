...
console.log(unsortedSumZero(sortedArr)); // O(n) and works on something unsorted (sort of, doesn't necessarily find the first item in the array that is unsorted, will need to refactor)